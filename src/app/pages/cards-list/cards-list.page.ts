...
export class CardsListPage implements OnInit {
  ...
  getProducts(){
    ...
    getProduct(id_carta: Number){ //ESTE NO ES EL QUE SELECCIONA EL ID PARA EL MODAL, ESO ESTÁ DENTRO DEL MODAL. ESTE PODRÍA SERVIR PARA SELECCIONAR LOS PRODUCTOS A TRAVÉS DE LA CARTA SELECCIONADA.
